	...
	public function renderTablecontents(): void
{
	...
	protected function createComponentPodcastForm(): Form
	{
	    ...
	    if ($this->getAction() === 'add'){
            ...
            ->setHtmlAttribute('hx-post','/myPodcasts/add/')
            ->setOmitted();
			
		} elseif ($this->getAction() === 'edit'){

			$form->addButton('placeholder','Save changes')
            ->setHtmlAttribute('hx-post','/myPodcasts/edit?podcastId='.$this->getParameter('podcastId'))
            ->setOmitted();
	...
	protected function createComponentDeleteForm(): Form
	{
		...
		->setHtmlAttribute('hx-post','/myPodcasts/cancelled/')
		->setOmitted();
		$form->addButton('delete')
            ->setHtmlAttribute('hx-post','/myPodcasts/delete?podcastId='.$this->getParameter('podcastId'))
			->setOmitted();
